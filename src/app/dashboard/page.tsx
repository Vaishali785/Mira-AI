...
import { DashboardLearningClient } from "./_components/DashboardLearningClient";
import { dashboardKpis } from "@/data/mock-data";
import { createHeatmapCells } from "@/lib/theme-utils";

export default function DashboardPage() {
    const heatmapCells = createHeatmapCells();

    return (
        <PageShell>
            <GreetingBanner />

            <section className="grid gap-2 px-0 py-3 *:min-w-0:min-w-0 sm:px-5 min-[900px]:grid-cols-4 xl:grid-cols-[1fr_1fr_1.7fr_1fr] xl:auto-rows-[minmax(100px,auto)]">
