									...
									<td className="px-[14px] py-3 text-center align-middle">
										{topic.done && topic.postId !== null ? (
											<button
												...
												className="inline-flex items-center gap-1 rounded-[6px] border border-(--rose-dim) bg-(--rose-dim) px-[10px] py-1 text-[11px] font-semibold text-(--rose) transition-colors hover:border-[color-mix(in_srgb,var(--rose),transparent_70%)] hover:bg-(--rose-glow)"
											>
												<svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
